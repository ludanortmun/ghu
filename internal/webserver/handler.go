...
type GitHubHandler struct {
	...
	sites   map[string]internal.GitHubTarget
}
...
func NewGitHubHandler(
	...
	return &GitHubHandler{
		fetcher: fetcher,
		sites:   make(map[string]internal.GitHubTarget),
	}
}
...
func (h *GitHubHandler) getTargetAndPath(originalPath string) (*internal.GitHubTarget, string) {
	path := originalPath

	var target *internal.GitHubTarget = nil
